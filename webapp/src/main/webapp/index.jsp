...
<head>
    <meta charset="UTF-8">
    <title>Flipkart Shopping Website india</title>
...
<body>
    ...
    <section id="home">
        <header>
            <span style="font-size:32px;margin-right:10px;color:white">Welcome to our Shopping Website India</span>
            <ul id="menu">
	...
	<h1>Flipkart ugadhi festive offers starts offers from 4th march to 23rd march</h1>
    </section>    
